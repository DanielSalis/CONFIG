...
if [[ $SECOND_MONITOR =~ "disconnected" ]]; then
  ...
  xrandr --output eDP-1 --primary --mode 1920x1080 --pos 1366x0 --rotate normal --output DP-1 --mode 1366x768 --pos 0x0 --rotate normal --output DP-2 --off --output HDMI-1 --off && feh --bg-scale /home/daniel/Imagens/wallpapers/tokyo-night-flower.png
fi
